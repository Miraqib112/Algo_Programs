...
void DFS(int G[][7], int start, int n)// it should take matrix i.e G 1st dimension is not require // starting point // and the order of the matrix i.e 7x7 
{
	static int visited[7] = { 0 }; // declare it as static array so that it can be accsessible to every call // intialized it as zero 
	int j;
