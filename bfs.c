...
void BFS(int G[][7], int start, int n) // it should take matrix i.e G 1st dimension is not require // starting point // and the order of the matrix i.e 7x7 
{
	int i = start, j; // for start of a traversal we need a variable 
